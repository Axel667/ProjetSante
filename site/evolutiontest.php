...
<body class="bg-white flex flex-col min-h-screen">
         ...
         <div class="flex space-x-4">
            ...
            <div class="hidden md:flex items-center space-x-1">
               ...
               <a href="evolutiontest.php"
                  class="bg-stone-100/10 px-4 py-4 border-2 border-stone-800 rounded-md ">Evolution</a>
   ...
   <body>
      <div class="container mt-6 mx-auto px-4">
         <h2 class="text-2xl font-semibold mb-4">Evolution d'un pays :</h2>
         <form action="evolutiontest.php" method="post" autocomplete="off" class="space-y-4">
            <div class="flex items-center space-x-4">
               <label for="Pays" class="text-gray-700 text-sm p-2 font-bold rounded-md border-2 border-indigo-700">Pays
                  1:</label>
               ...
               <label for="pib" class="text-gray-700 text-sm font-bold">PIB :</label>
               <select class="form-select" name="pib">
                  <OPTION VALUE="PIB par habitant">PIB</OPTION>
               </SELECT>

               <label for="donnée" class="text-gray-700 text-sm font-bold">Données :</label>
               <select class="form-select" name="donnée">
               ...
               <div class="flex items-center">
                  <button type="submit"
                     class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Voir
                     l'évolution</button>
               </div>
            </div>
         </form>
