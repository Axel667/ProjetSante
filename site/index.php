...
<body>
  ...
  ?>
   <div class="btn-index">
      ...
      <div class="link-btn">
         <a href="carte.html" class="btn btn-light btn-lg"><img class="tb" src="img/world@2x.png">Découvrez notre
            carte</a>
      </div>

      <div class="link-btn">
         <a href="comparaison2.php" class="btn btn-light btn-lg"><img class="tb" src="img/compare@2x.png">Comparez
            les pays</a>
      </div>

      <div class="link-btn">
         <a href="create.php" class="btn btn-light btn-lg"><img class="tb" src="img/user-1@2x.png">Publiez votre
            article</a>
      </div>
   </div>
</body>
